...
export default function HomePage() {
  ...
  return (
    <main className="neo-page main-dynamic min-h-screen !bg-[#5AEE74] px-4 py-8 sm:px-8 sm:py-12">
      <div className="neo-stage mx-auto flex w-full max-w-5xl items-center justify-center">
        <section className="neo-main-card neo-main-card-frame main-card-enter w-full max-w-4xl border-[1.5px] border-transparent !bg-white px-5 pt-7 pb-6 sm:px-12 sm:pt-9 sm:pb-8">
          <div className="mx-auto flex w-full max-w-2xl flex-col items-center text-center">
            <span className="main-option-badge main-badge-float main-stagger-1">
          ...
          <div className="mx-auto flex w-full max-w-2xl flex-col items-center text-center">
            ...
            <button
              ...
              onClick={handleStart}
              disabled={!canStart}
              className={`comic-start-btn mt-10 sm:mt-11 inline-flex h-[56px] min-w-[220px] items-center justify-center gap-2 rounded-[12px] border-[3px] border-black px-8 text-[23px] font-black tracking-tight transition ${
                canStart
                  ? "is-active !bg-[#55E96F] !text-[#111111]"
                  : "is-disabled !bg-[#CFECD8] !text-[#4C7D58] opacity-70"
              } main-stagger-5 main-btn-pop`}
            >
              프로젝트 시작하기
              <svg
                width="18"
