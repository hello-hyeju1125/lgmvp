...
export function Ep5BlueprintScene({ userName }: Ep5BlueprintSceneProps) {
  ...
  return (
    <div className="mx-auto w-full max-w-3xl space-y-6">
      <h2 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-black/90">{ep5Scene.title}</h2>
      <p className="text-[18px] font-extrabold leading-[1.85] text-black/90">
        <span className="text-black/90">[Situation]</span> {renderWithBold(ep5Scene.situation)}
      </p>
      ...
      <div className="rounded-2xl border border-black/10 bg-gray-50 p-5 shadow-[0_12px_40px_rgba(0,0,0,0.06)]">
        <div className="border-l-4 border-[#E4003F] pl-4">
          <p className="text-[13px] font-extrabold text-black/85">팀원들</p>
                ...
                <div className="flex items-center justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 line-clamp-2 text-[14px] leading-[1.75] text-black/40 blur-[0.6px]">
                      {renderWithBold(ep5Scene.dialogue[0] ?? "")}
                    </p>
                  </div>
      ...
      <p className="text-[18px] font-extrabold leading-[1.85] text-black/90">
        <span className="text-black/90">[Action]</span> {renderWithBold(ep5Scene.action)}
      </p>
