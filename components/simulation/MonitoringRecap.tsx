...
function AnimatedKpiBar({
  ...
  return (
    ...
    >
      ...
      <span className="plan-recap-accent-text w-[48px] shrink-0 text-right text-[16px] font-extrabold tabular-nums sm:text-[18px]">
        {displayPct}%
      </span>
      <span
...
export function MonitoringRecap({ userName: _userName }: MonitoringRecapProps) {
  ...
  return (
    <section className="ep1-scene-layout w-full min-w-0 max-w-none">
      ...
      {/* 풋터 문구 — plan-recap과 동일 오프셋(의사결정 카드 +6/+7 스텝) */}
      <div className="mt-16 space-y-1 px-2 text-center sm:mt-20">
        <p
          ...
          style={revealDelay(decisionCardStep + 6)}
        >
