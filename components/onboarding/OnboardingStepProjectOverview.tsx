...
const kpiGroups = [
  {
    ...
    items: [
      ...
      },
      {
        subtitle: "Delivery",
        title: "일정 준수",
        desc: "\"주어진 제한 시간 내에 지연 없이 프로젝트 마일스톤을 달성하고 결과물을 적기에 납품하였는가?\" 프로젝트 착수부터 대시보드 프로토타입 오픈까지의 전체 일정을 체계적으로 관리하여, 기한 내에 목표를 완수하는 진척도 관리 역량을 평가합니다.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        title: "팀 몰입도",
        desc: "\"팀원들의 잠재력을 발굴하고, 하나의 목표를 향해 자발적으로 몰입하는 팀 문화를 만들었는가?\" People Manager로서 프로젝트 팀원 개개인의 동기를 부여하고 역량을 끌어올려, 적극적이고 건강한 조직 문화를 조성하는 것을 목표로 합니다.",
      },
      {
        subtitle: "Stakeholder Alignment",
        title: "이해관계자 조율",
        desc: "\"이해관계가 얽힌 유관부서 및 상위 조직과의 갈등을 해결하고, 적극적인 협조와 지원을 이끌어냈는가?\" CS, 마케팅 등 타 부서와의 원활한 소통 및 이해관계 조율을 통해, 프로젝트의 강력한 추진 동력을 확보하는 능력을 평가합니다.",
      },
    ],
  },
];
