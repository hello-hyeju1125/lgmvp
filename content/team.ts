...
export const teamMembers: TeamMemberProfile[] = [
  {
    ...
    name: "김지훈",
    role: "선임 (IT데이터팀)",
    quote: "합리성과 효율이 중요하죠. 원하시는 바를 명확히, 필요 데이터와 함께 주시면 최선을 다해 구현해 드립니다. 누구보다 AI, 디지털에 관심도 많습니다!",
    age: 32,
    gender: "남성",
    years: 5,
    dept: "IT데이터팀",
  ...
  },
  {
    ...
    name: "박소진",
    role: "책임 (마케팅전략팀)",
    quote: "마케팅팀의 업무에 도움이 되도록 하는 것이 목표입니다. 고객 접점 조직이니, 우리의 생각을 잘 반영한다면 고객 가치도 올라가리라 생각해요.",
    age: 41,
    gender: "여성",
    years: 15,
    dept: "마케팅전략팀",
  ...
  },
  {
    ...
    name: "이민수",
    role: "책임 (고객가치혁신팀)",
    quote: "리더님이 필요로 하시는 역할을 하겠습니다. 경험이 많고, 성실하게 맡은 바 일을 수행하는 것이 저의 가장 큰 장점이죠.",
    age: 46,
    gender: "남성",
    years: 20,
    dept: "고객가치혁신팀",
  ...
  },
  {
    ...
    name: "최유라",
    role: "선임 (글로벌CS팀)",
    quote: "해외 VOC는 제가 잘 알지만, AI에 대해서는 아직 잘 몰라요. 두렵긴 하지만 그래도, AI를 배워서 성장하고 싶은 마음이 크답니다.",
    age: 29,
    gender: "여성",
    years: 6,
    dept: "글로벌CS팀",
  ...
  },
  {
    ...
    name: "정태영",
    role: "책임 (인프라보안팀)",
    quote: "제 몸은 하나네요. 제 팀에서의 본업이 있으니, 프로젝트 업무 요청은 최대한 미리 부탁드려요. \"그렇다고 프로젝트 팀 일을 소홀히 하고싶지는 않아요.\"",
    age: 43,
    gender: "남성",
    years: 15,
    dept: "인프라보안팀",
  ...
  },
  {
    ...
    name: "Sarah Lee",
    role: "매니저 (북미지역본부 마케팅)",
    quote: "본사와의 긴밀한 협업 너무 좋지요. 오픈 마인드로 협력하고 싶어요. (오프라인 상태) 메일 남겨주시면 내일 출근 후 회신드리겠습니다.",
    age: 35,
    gender: "여성",
    years: 9,
    dept: "북미지역본부 마케팅",
...
export const stakeholders: StakeholderProfile[] = [
  {
    ...
    name: "김혁기",
    role: "부사장",
    quote: "Simple is the Best야. 직관적인 것이 가장 좋지. 덧붙여 도전적인 목표가 있어야 혁신이 나오는 법이야. 안되면 되게 합시다, 여러분!",
    position: "(경영혁신본부장 / 프로젝트 스폰서)",
  ...
  },
  {
    ...
    name: "최성민",
    role: "상무",
    quote: "무조건 데이터로 커뮤니케이션 합시다. 시각적으로 잘 보여지는 것이 보고에서 가장 중요하지요. 우리 팀도 이런 부분들을 생각하면서 일하면 좋겠어요.",
    position: "(고객가치혁신담당 / 프로젝트 챔피언)",
    description: "최고위 임원(부사장)의 지시를 PM에게 전달하고 압박/관리함. 부사장의 무리한 지시를 방어해 주기보다는 그대로 하달하며, 실무진의 고충보다는 상부의 니즈에 맞는 가시적인 성과와 '완벽한 보고서'를 중시함.",
    tags: ["#보고서_장인", "#부사장님_바라기", "#중간보스의_비애", "#화려한_장표선호", "#압박전담반"],
  },
];
