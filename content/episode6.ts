...
export const ep6Block2Options: Ep6BlockOption[] = [
  ...
  {
    id: "F",
    headline: "직접 자리로 찾아가기 · 대면으로 강행 돌파",
    label: "직접 자리로 찾아가기 (물리적 대면을 통한 강행 돌파)",
  },
];
  ...
  switch (block4) {
    ...
    case "D":
      ...
      return {
        ...
        kpi: bestChannel ? kpi({ delivery: 3, stakeholderAlignment: 4, teamEngagement: 2 }) : kpi({ delivery: 2, stakeholderAlignment: 4, teamEngagement: 2 }),
    ...
    case "A":
      return {
        ...
        kpi: kpi({ delivery: -2, stakeholderAlignment: -2, teamEngagement: -1, leaderEnergy: -6 }),
    ...
    case "C":
      return {
        ...
        kpi: kpi({ delivery: 1, teamEngagement: -1, leaderEnergy: -9 }),
    ...
    case "E":
      return {
        ...
        kpi: kpi({ delivery: 1, teamEngagement: -2, stakeholderAlignment: -3, leaderEnergy: -3 }),
