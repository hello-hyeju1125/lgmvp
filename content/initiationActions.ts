...
export const initiationScreenCopy = {
  ...
  scenarioLines: [
    ...
    "당신은 **AI 전문가가 아니며**, C-level 김혁기 본부장은\n당초 예상보다 더 **파격적인 목표 달성**을 기대하고 있습니다.",
    "제한된 준비 기회 안에서, 당신은 무엇을 가장 먼저 선택하겠습니까?",
  ],
  selectionInstruction:
    "아래 '**착수 단계 핵심 액션 카드**' 5개를 검토하고,\n그 중 2개를 선택해 **전략을 구성**하세요.",
  /** 안내 문장 (첫 줄 + 줄바꿈 + 둘째 줄) */
  instructionLine: {
    line1Prefix: "아래 ",
    highlight: "'착수 단계 핵심 액션 카드'",
    line1Suffix: " 5개를 검토하고,",
    line2: "그 중 2개를 선택해 전략을 구성하세요.",
  },
  tipBullets: [
    "선택 즉시 액션 카드가 고정되며, 앞으로의 의사결정 흐름과 화면 상단의 5가지 상태 지표에 직접적인 영향을 줍니다.",
    "PMBOK은 미국 PMI가 정리한 프로젝트 관리 글로벌 표준입니다.",
    "각 액션 카드는 특정 PMBOK 지식영역과 연결되어 있으며, 어떤 2장을 고르는지에 따라 리더의 관점과 이후 대응 방식이 달라집니다.",
  ],
