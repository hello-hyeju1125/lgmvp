/** Screen 20. 실행 단계 액션 선택 */
export const EXECUTION_TOTAL_HOURS = 80;
/** exec-action: 선택 가능한 액션 개수 (각 8h 토글) */
export const EXEC_ACTION_MAX_SELECTED = 4;
...
export const executionScreenCopy = {
  briefingBadge: "실행의 첫 스프린트를 시작합니다.",
  /** exec-action 시나리오. {{SPRINT}} → 형광+툴팁 */
  execScenarioIntro:
    "치밀한 기획을 마쳤으니, 실제 업무가 본격적으로 시작됩니다.\n실행 단계는 전체 6개월의 프로젝트 중 \n가장 길고 험난한 마라톤 구간이 될 것입니다.\n지금부터 본격적인 '첫 2주간의 개발 {{SPRINT}}'가 시작됩니다.\n\n아래 10가지 액션 아이템 중 \n어떤 아이템을 4개 선택하시겠습니까?",
