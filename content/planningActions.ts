...
export const planningScreenCopy = {
  intro1:
    "폭풍 같았던 착수 단계가 지나고, 프로젝트의 목표와 범위가 어느 정도 합의되었습니다.\n하지만 진정한 위기는 이제부터입니다.\n\"어떻게(How)\" 만들 것인지에 대한 촘촘한 {{WBS}}와 리스크 대비책이 없다면,\n실행 단계에서 팀은 곧바로 좌초하게 됩니다.\n\n아래 제시된 '기획 단계 핵심 액션 아이템'들을 확인하고,\n그 중 2개를 선정합니다.",
  popupIntro:
    "리더님의 치밀했던 기획 주간이 지났습니다.\n선택하신 액션에 따라 아래와 같은 항해 지도를 완성했습니다.",
